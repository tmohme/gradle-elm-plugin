...
* Versions >=3.3.0 are compatible with elm 0.19 and Gradle >= 4.9  (tested with 4.9 .. 5.6.4)
* Versions 3.2.0 .. 3.2.2 are compatible with elm 0.19 and Gradle >= 4.4.1  (tested with 4.4.1 .. 5.6)
